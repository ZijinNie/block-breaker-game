...
public class UpdateGamePage extends JFrame {
	...
	// game name & number of levels & blocks
	...
	private void initComponents() {
		...
		gameNameTextField.setText(Block223Application.getCurrentGame().getName());
		...
		nrLevelsTextField = new JTextField(Integer.toString(Block223Application.getCurrentGame().numberOfLevels()));
		...
		nrBlocksSlider.setValue(Block223Application.getCurrentGame().getNrBlocksPerLevel());
		nrBlocksSlider.setPaintLabels(true);
		nrBlocksSlider.setMajorTickSpacing(99);
		nrBlocksTextField = new JTextField(Integer.toString(Block223Application.getCurrentGame().getNrBlocksPerLevel()));
		...
		minBallSpeedXSlider.setValue(Block223Application.getCurrentGame().getBall().getMinBallSpeedX());
		minBallSpeedXSlider.setPaintLabels(true);
		minBallSpeedXSlider.setMajorTickSpacing(100);
		minBallSpeedXTextField = new JTextField(Integer.toString(Block223Application.getCurrentGame().getBall().getMinBallSpeedX()));
		minBallSpeedYLabel = new JLabel();
		minBallSpeedYLabel.setText("Min Y Speed");
		minBallSpeedYSlider = new JSlider(0, 100, 1);
		minBallSpeedYSlider.setValue(Block223Application.getCurrentGame().getBall().getMinBallSpeedY());
		minBallSpeedYSlider.setPaintLabels(true);
		minBallSpeedYSlider.setMajorTickSpacing(100);
		minBallSpeedYTextField = new JTextField(Integer.toString(Block223Application.getCurrentGame().getBall().getMinBallSpeedY()));
		...
		ballSpeedIncreaseFactorSlider.setValue((int)(Block223Application.getCurrentGame().getBall().getBallSpeedIncreaseFactor() * 10));
		ballSpeedIncreaseFactorSlider.setPaintLabels(true);
		ballSpeedIncreaseFactorSlider.setLabelTable(bsifTable);
		ballSpeedIncreaseFactorTextField = new JTextField(Double.toString(Block223Application.getCurrentGame().getBall().getBallSpeedIncreaseFactor()));
		...
		maxPaddleLengthSlider.setValue(Block223Application.getCurrentGame().getPaddle().getMaxPaddleLength());
		...
		maxPaddleLengthTextField = new JTextField(Integer.toString(Block223Application.getCurrentGame().getPaddle().getMaxPaddleLength()));
		minPaddleLengthLabel = new JLabel();
		minPaddleLengthLabel.setText("Min Length");
		minPaddleLengthSlider = new JSlider();
		minPaddleLengthSlider.setValue(Block223Application.getCurrentGame().getPaddle().getMinPaddleLength());
		minPaddleLengthSlider.setMinimum(1);
		minPaddleLengthSlider.setMaximum(390);
		minPaddleLengthSlider.setPaintLabels(true);
		minPaddleLengthTextField = new JTextField(Integer.toString(Block223Application.getCurrentGame().getPaddle().getMinPaddleLength()));
		...
		layout.setHorizontalGroup(layout.createParallelGroup()
				...
				.addGroup(layout.createSequentialGroup().addComponent(gameNameLabel).addComponent(gameNameTextField))
		...
		layout.linkSize(SwingConstants.VERTICAL,
				new java.awt.Component[] { gameNameTextField, nrLevelsTextField, nrBlocksTextField, minBallSpeedXTextField,
		...
		layout.setVerticalGroup(layout.createSequentialGroup()
				...
				.addComponent(generalSettingLabel)
				.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(gameNameLabel)
	...
	private void applyActionPerformed(java.awt.event.ActionEvent evt) throws InvalidInputException {
		...
		// call the controller
		try {
			Block223Controller.updateGame(gameNameTextField.getText(),
				Integer.parseInt(nrl),
				Integer.parseInt(nrb), Integer.parseInt(mbsx),
				Integer.parseInt(mbsy),
				Double.parseDouble(bsif),
				Integer.parseInt(maxpl),
				Integer.parseInt(minpl));
			// String name, int nrLevels, int nrBlocksPerLevel, int minBallSpeedX, int minBallSpeedY,
		...
		try {
			...
			throw new InvalidInputException("Cannot save the update");
		}
	}
